...
public class AppSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/customer/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_CUSTOMER", "ROLE_EMPLOYEE")
                .antMatchers("/employee/**").hasAnyAuthority("ROLE_EMPLOYEE","ROLE_ADMIN")
                .antMatchers("/allCustomers").hasRole("ADMIN")
                .antMatchers("/allCustomers").hasAnyAuthority("READ", "WRITE")
                .antMatchers("/allCustomers").hasRole("EMPLOYEE")
                .antMatchers("/allCustomers").hasAuthority("READ")
